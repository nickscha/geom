...
public class Vec3fTest {
    ...
    Vec3f first = Vec3f.of(6, 4, 2);
    Vec3f second = Vec3f.of(4, 2, 1);
    ...
    public void testOfOther() {
        Vec3f other = Vec3f.of(6, 2, 1);
        Assert.assertEquals(Vec3f.of(6, 2, 1), Vec3f.of(other));
    }

    @Test
    public void testTranslationMatrix() {
        Mat4f res = Vec3f.of(6, 2, 1).translationMatrix();
    ...
    public void testRotationMatrix() {
        Mat4f res = Vec3f.of(6, 2, 1).rotationMatrix();

        float[][] expArr = new float[4][4];
        expArr[0][0] = 0.99923867f;
        expArr[0][1] = -0.021004235f;
        expArr[0][2] = -0.032878753f;
        expArr[0][3] = 0;
        expArr[1][0] = 0.017441774f;
        expArr[1][1] = 0.9943068f;
        expArr[1][2] = -0.10511829f;
        expArr[1][3] = 0;
        expArr[2][0] = 0.034899496f;
        expArr[2][1] = 0.10446479f;
        expArr[2][2] = 0.9939161f;
        expArr[2][3] = 0;
        expArr[3][0] = 0;
        expArr[3][1] = 0;
        expArr[3][2] = 0;
